...
9. [Multiplication table using for loop](table/report.html)
10. [Pattern using nested for loop](pattern/report.html)
11. [Display content of a structure](struct1/report.html)
12. [Create and display content of the structure book](structure/report.html)
13. [Factorial of a number](factorial/report.html)
14. [Print fibonacci series upto n terms](fibonacci/report.html) 
